...
class LowercaseLetterScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Central Image
        center_image = Image(source='images/ABCALPHA.png', size_hint=(None, None), size=(150, 160), pos_hint={'center_x': 0.15, 'center_y': 0.6})
        ...
        button_positions = [(0.60, 0.5), (0.75, 0.5), (0.9, 0.5)]  

        for img_source, pos in zip(button_images, button_positions):
            img_button = ImageButton(source=img_source, size_hint=(None, None), size=(100, 100), pos_hint={'center_x': pos[0], 'center_y': pos[1]})
        ...
        scroll_view = ScrollView(size_hint=(1, 0.35), do_scroll_x=True, do_scroll_y=False)
