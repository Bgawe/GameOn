...
class FlashCardScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.back_to_menu_button = ImageButton(source='images/back.png', size_hint=(None, None), size=(100, 50), pos_hint={'x': 0, 'top': 0.97})
    ...
    def animate_flashcard(self, instance=None, initial=False):
        ...
        scale_up = Animation(size=(250, 250), duration=0.3)
        scale_down = Animation(size=(150, 150), duration=0.2)
